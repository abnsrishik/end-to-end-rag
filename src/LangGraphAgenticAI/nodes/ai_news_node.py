...
class AINewsNode:
    def __init__(self,llm):
        """
        Initialize the AINewsNode with API keys from tavily and GROQ.
        """
        self.tavily = TavilyClient()
        self.llm = llm
        # this is used to capture various steps in this file so that later can be use for shown
        self.state = {}
    ...
    def fetch_news(self, state:dict) -> dict:
        ...
        Args:
            state (dict): The state sictionary containing 'frequency'.
        ...
        response = self.tavily.search(
            query = "Top Artificial Intelligence (AI) technoly news in India and globally",
            topic = 'news',
    ...
    def summarize_news(self, state: dict) -> dict:
        ...
        Returns:
            dict: Updated state with 'summary' key containing summarized data.
